...
class VisitCountries extends Component {
  ...
  changeCard = id => {
    this.setState(prev => ({
      visitedCountriesList: prev.visitedCountriesList.map(each => {
        if (each.id === id) {
  ...
  render() {
    ...
    const filteredList = visitedCountriesList.filter(
      ...
      <div className="countries-container">
        ...
        {filteredList.length === 0 ? (
          <div className="no-countries-visited">
            <p className="no-countries-visited-heading">
